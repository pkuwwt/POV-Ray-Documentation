...
#case (0)
  ...
  #declare Camera_Position = < 25.00, 2.00, -70.00> ;  // front view
  #declare Camera_Look_At  = < 25.00, 2.00,  0.00> ;
  #declare Camera_Angle    =  65 ;
#break
#case (1)
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Orthographic_On = 0;// don't use fish eye - for proper text
  #declare Camera_Position = <120.50, 230.00, -180.0+0.00 > ;  // front view
  #declare Camera_Look_At  = <118.50,   0.00,   50.0+0.01> ;
  #declare Camera_Angle    = 45;
#break
#case (2) // Orthographic view vertically down
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Orthographic_On = 1;// don't use fish eye - for proper text
  #declare Camera_Position = <0.60*N, 260.00,  0.34*N+0.00 > ;  // front view
  #declare Camera_Look_At  = <0.60*N,   0.00,  0.34*N+0.01> ;
  #declare Camera_Angle    = 30;
#break
#case (3) // aspect ratio 4:3 
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Orthographic_On = 1;// don't use fish eye - for proper text
...
#case (4)
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Orthographic_On = 1;// don't use fish eye - for proper text
  #declare Camera_Position = <15.00, 50.00,-0.0+0.00 > ;  // front view
  #declare Camera_Look_At  = <15.0,   0.00, -0.0+0.01> ;
