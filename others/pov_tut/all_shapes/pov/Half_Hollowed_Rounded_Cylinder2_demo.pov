// POV-Ray 3.6/3.7 Scene File "Half_Hollowed_Rounded_Cylinder2_demo.pov"
...
#declare Camera_0 = camera {/*ultra_wide_angle*/ angle 50   // front view
                            ...
                            look_at   <0.0 , 1 , 0.0> }
#declare Camera_1 = camera {/*ultra_wide_angle*/ angle 34  // diagonal view
                            location < 5.00, 7.00, -5.00>
                            right     x*image_width/image_height
                            look_at  < 0.20, 1.20,  0.00> }
...
object{ AxisXYZ( 12, 5.75, 12, Texture_A_Dark, Texture_A_Light) scale 0.25 translate <0,1.5,0>}
...
object { Half_Hollowed_Rounded_Cylinder2( //  
                                5.5,// total length end to end 
                                1.5,// R_out, outer radius 
                                0.7,// R_End // corner radius  <R_out
                                0.2,// R_Border 
                                0.5, //  border scale y ( >0 ), 0 = no borders!
...
/*
      ...
      material{   //-----------------------------------------------------------
        texture { pigment{ rgbf <0.98, 0.98, 0.98, 0.89> }
