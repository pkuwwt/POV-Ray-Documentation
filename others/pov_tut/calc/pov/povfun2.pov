// POV-Ray 3.6 / 3.7 Scene File "povfun2.pov"
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)         ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<1,0.65,0>  }  translate< X,     2*X*X   ,0>}
                                                                          
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0.5,1,0>   }  translate< X,     1*X*X   ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color Green*0.5      }  translate< X,   0.5*X*X   ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.2,0.5> }  translate< X,  0.25*X*X   ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.1,0.4> }  translate< X, 0.125*X*X   ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.0,0.2> }  translate< X,0.0625*X*X   ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color rgb<0.5,1,0>  }  translate< X,0.5*(X-2)*(X-2)-4 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<1,0.35,0>  }  translate< X,-2*(X+3)*(X+3)+4  ,0>}

 // next step:
 #declare X = X + 0.004;  // next Nr  <<<-- increase this value if you have not enough RAM 
