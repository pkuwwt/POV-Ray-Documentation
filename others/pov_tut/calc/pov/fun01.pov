...
object{ AxisXY( 5.0, 3.5, Texture_A_Dark, Texture_A_Light)}
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)         ,0>}
  sphere{ <0,0,0>,0.045 pigment{ color rgb<1,0.25,0>  }  translate< X, abs(X),0>}

  sphere{ <0,0,0>,0.045 pigment{ color rgb<1,0,0.25>  }  translate< X, mod(X,1),0>}

  sphere{ <0,0,0>,0.045 pigment{ color rgb<0.3,0.8,0> }  translate< X, div(X,1),0>}

  sphere{ <0,0,0>,0.045 pigment{ color rgb<0.3,0.0,0.7> }  translate< X, 0.25*div(sin(X/2*pi),0.25)-2,0>}
