// POV-Ray 3.6 / 3.7 Scene File "povfun5.pov"
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)                      ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<1,0.65,0> }  translate< X, 1/4*X*X*(X+4)/(X+2)       ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color rgb<0.5,1,0>  }  translate< X, 1/2*X+1/2-2/((X+2)*(X+2)) ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color Green*0.5     }  translate< X, 1/2+4/((X+2)*(X+2)*(X+2)) ,0>}
