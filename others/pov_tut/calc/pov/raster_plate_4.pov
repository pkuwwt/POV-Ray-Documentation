...
#case (1)
  ...
  #declare Camera_Position = < 3.00, 3.00, -4.00> ;  // diagonal view
  #declare Camera_Look_At  = <-0.30, 0.10,  0.00> ;
  #declare Camera_Angle    =  65;
  #declare Camera_Rotate = <0,0,0>;  
#break
#case (2)
...
sky_sphere{ pigment{ gradient <0,1,0>
                     color_map{ [0   color rgb<1,1,1>         ]//White
                                [0.1 color rgb<0.24,0.34,0.56>]//~Navy
                                [0.9 color rgb<0.24,0.34,0.56>]//~Navy
...
//--------------------------------------------------------------------------------
object{ Raster_Plate( 1.0,   0.010, // RD1, Width1,//primary raster distance/width,
                      0.1,   0.045, // RD2, Width2,//secondary raster distance/width, 
                      B_Tex, // Base_Texture, // non = pigment { Clear } 
                      0.6, // Intensity, // Line gray intensity
                      <-2,-0.05,-2>, <2,0,2>, //Start_Box, End_Box, // vectors
                    ) //----------------------------------------------------------
...
object{ Raster_Plate( 1.0,   0.010, // RD1, Width1,//primary raster distance/width,
                      ...
                      B_Tex, // Base_Texture, // non = pigment { Clear } 
                      0.6, // Intensity, // Line gray intensity
                      <-2,-0.05,-0>, <2,0,2>, //Start_Box, End_Box, // vectors
                    ) //----------------------------------------------------------
...
plane { <0,1,0>, 0    // plane with layered textures
        texture { pigment{color White*1.1}
         ...
         texture { Raster_Lines(1.0, 0.015, 0.8) rotate<0,0,0> }
         texture { Raster_Lines(1.0, 0.015, 0.8) rotate<0,90,0>}
        rotate<0,0,0>
      }
