// POV-Ray 3.6 / 3.7 Scene File "fun02.pov"
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)         ,0>}
  sphere{ <0,0,0>,0.045 pigment{ color rgb<1,0.25,0>  }  translate< X, X*X*0.25,0>}

  sphere{ <0,0,0>,0.045 pigment{ color rgb<1,0,0.25>  }  translate< X, ceil(X*X*0.25),0>}

  sphere{ <0,0,0>,0.045 pigment{ color rgb<0.25,0,0.75>  }  translate< X, floor(X*X*0.25),0>}
