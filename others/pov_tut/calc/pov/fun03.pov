// POV-Ray 3.6 / 3.7 Scene File "fun03.pov"
...
#declare Camera_0 = camera { perspective
                             location  < 0.00, 3.50,-40.0>
                             look_at   < 0.00, 3.50, 0.00>
                             angle 15.7
...
object{ AxisXY( 5.0, 6.5, Texture_A_Dark, Texture_A_Light)}
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)         ,0>}
  sphere{ <0,0,0>,0.045 pigment{ color rgb<0.7,0.0,0>  }  translate< X,0.5*(1-cos(X*pi)),0>}

  sphere{ <0,0,0>,0.055 pigment{ color rgb<0.5*(1-cos(X*pi)),0.5,0>  }  translate< X, 1*sin(X*pi)+2,0>}

  sphere{ <0,0,0>,0.055 pigment{ color rgb<0.5*(1-cos(X*pi)),0,1-0.5*(1-sin(X*pi))>  }  translate< X,1.5*sin(X*pi)+3,0>}

  sphere{ <0,0,0>,0.055 pigment{ color rgb<0.5*(1-cos(X*pi)),1-0.35*(1-cos(X*pi)),0>  }  translate< X,2*sin(X*pi)+4,0>}

 // next step:
 #declare X = X + 0.01;  // next Nr  <<<-- increase this value if you have not enough RAM 
