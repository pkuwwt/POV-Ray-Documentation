// POV-Ray 3.6 / 3.7 Scene File "povfun3.pov"
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)         ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<1,0.65,0>  }  translate< X,   sin(X)   ,0>}
                                                                          
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0.5,1,0>   }  translate< X,   cos(X)   ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color Green*0.5      }  translate< X, sin(4*X)-2 ,0>}

  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.2,0.5> }  translate< X,0.5*sin(1.5*X)+1*sin(8*X)+3 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<1,0.35,0>  }  translate< X,sin(0.75*X)*sin(16*X)-4 ,0>}
