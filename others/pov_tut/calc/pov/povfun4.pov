// POV-Ray 3.6 / 3.7 Scene File "povfun4.pov"
...
union{
 ...
 // Zeichnen der "Punkte"  ( X / f(X) ):
                       ...
                       //       Color - Farbe                  //< X, f(X)           ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<1,0.65,0>  }  translate< X,1/4*1/(X+1) +2 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0.5,1,0>   }  translate< X,1/4*2/(X+1) +2 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color Green*0.5      }  translate< X,1/4*3/(X+1) +2 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.2,0.5> }  translate< X,1/4*4/(X+1) +2 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.1,0.4> }  translate< X,1/4*5/(X+1) +2 ,0>}
  sphere{ <0,0,0>,0.025 pigment{ color rgb<0,0.0,0.2> }  translate< X,1/4*6/(X+1) +2 ,0>}
