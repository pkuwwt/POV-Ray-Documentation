// POV-Ray 3.6 / 3.7 Scene File "axis_n3.pov"
...
#declare Cam0 = camera{ //ultra_wide_angle 
                        ...
                        look_at   <0.0 , 1.0 , 0.0>}
#declare Cam1 = camera{ ultra_wide_angle angle 11.5 
                        location  <10.0 , 20.5 ,-30.0>
                        right     x*image_width/image_height
                        look_at   <0.5 , 1.5 , 0.0>}
camera{Cam1}
// sun ---------------------------------------------------------------
...
text{ttf"arial.ttf",  "x",  0.15,  0 no_shadow
     texture{TexRed} 
     scale 0.5 translate <AxisLenX+0.05,0.35,-0.12>}
text{ttf"arial.ttf",  "y",  0.15,  0 no_shadow 
     texture{TexRed} 
     scale 0.5 translate <-0.50,AxisLenY+0.05,-0.05>}
text{ttf"arial.ttf",  "z",  0.15,  0 no_shadow
     texture{TexRed} 
     scale 0.5 translate <-0.65,0.2,AxisLenZ+0.50>}
} // end of union
...
#declare Tex_Dark =  texture{ pigment{ color rgb<1,0.55,0>}
                              finish { phong 1}}
#declare Tex_White = texture{ pigment{ color rgb<1,1,1>}
                              finish { phong 1}}

object{ AxisXYZ( 3.5, 3.5,6.25, Tex_Dark, Tex_White)}
...
object{ Grid ( 1.0, 0.025, pigment{color rgb<1,1,1>*1.5} )  rotate< 0,0,0>}

cone{<0,0,0>,1,<0,1.5,0>,0   translate<2,0,2>
