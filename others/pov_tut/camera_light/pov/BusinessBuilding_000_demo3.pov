// POV-Ray 3.6/3.7 Scene File "BusinessBuilding_000_demo2.pov"
...
#case (0)
  #declare Camera_Location = < 0.00,  1.60,-60.00> ;  // front view
  #declare Camera_Look_At  = < 0.00, 15.00,  0.00> ;
  #declare Camera_Angle    =  45 ;
#break
#case (1)
  #declare Camera_Location = <51.00,  1.60, -23.00> ;  // 
  #declare Camera_Look_At  = <-2.50, 18.00,  12.00 > ;
  #declare Camera_Angle    =  45 ;
#break
#case (2)
  #declare Camera_Location = <60.0,  1.6 , 0.0> ;  // right side view
  #declare Camera_Look_At  = < 0.0, 15.0,  0.0> ;
  #declare Camera_Angle    =  90 ;
#break
#case (3)
  #declare Camera_Location = < 0.00,65.00,  0+0.000> ;  // top view
  #declare Camera_Look_At  = < 0.00, 0.00,  0+0.001> ;
  #declare Camera_Angle    = 90 ;
#break
#else
  #declare Camera_Location = < 0.00, 1.00, -50.00> ;  // front view
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{<  500,2500,-1500> color rgb<1,1,1>*0.9}                // sun 
...
#declare RasterHalfLine  = 0.5 ;  
#declare RasterHalfLineZ = 0.5 ; 
//-------------------------------------------------------------------------
...
object{ BusinessBuilding_000( 
                    5, // Nx_Elements,  // number of elements in -x,  integer >= 1
                    11, // Ny_Floors,    // number of floors in    y,  integer >= 1
                    3, // Nz_Elements,  // number of elements in +z,  integer >= 1
                    5, // N_of_Windows_per_Element, // 
...
//-------------------------------------------------------------------------------------//
object{ BusinessBuilding_000( 
                    3, // Nx_Elements,  // number of elements in -x,  integer >= 1
                    8, // Ny_Floors,    // number of floors in    y,  integer >= 1
                    2, // Nz_Elements,  // number of elements in +z,  integer >= 1
                    5, // N_of_Windows_per_Element, // 
        ...
        scale <1,1,1>*1
        rotate<0, 0,0> 
        translate<3*(5*1.00++0.35)+0.35,0.00,2*(5*1.00++0.35)> 
      } //---------- 
//-------------------------------------------------------------------------------------//
//-------------------------------------------------------------------------------------//
