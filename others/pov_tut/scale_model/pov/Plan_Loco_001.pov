// POV-Ray 3.6 / 3.7 Scene File "Plan_Loco_001.pov"
...
#case (0)
  ...
  #declare Camera_Position = < 0.00, 2.48, -14.50> ;  // front view                                                                 
  #declare Camera_Look_At  = < 0.00, 2.48,  0.00> ;
  #declare Camera_Angle    =  40 ;
#break
#case (1)
  #declare Ultra_Wide_Angle_On = 0; 
  #declare Orthographic_On = 0; 
  #declare Camera_Position = < 25.00, 15.00, -25.00> ;  // diagonal view
  #declare Camera_Look_At  = <-0.60,  1.70, -1.60> ;
...
object{ AxisXYZ( 10.0, 8.5, 0, Texture_A_Dark, Texture_A_Light) scale 0.5}
...
//--------------------------------------------------------------------------------
object{ Raster_Plate( 1.0,   0.010, // primary raster distance/width,
                      0.1,   0.080, // secondary raster distance/width, 
                      Base_Texture, // non = pigment { Clear } 
                      0.6, // Intensity, // Line gray intensity
                      <-5.13,-0.05,-0.0>, <5.13,0,5.10>, //Start, End, // vectors
                    ) //----------------------------------------------------------
        rotate<-90,0,0> 
        translate<0,0.001,0>
      } //-----------------------------------------------------------------------------
...
box{ <0,0,0>,<1,1,0.00001> 
   texture{
    pigment{
     ...
     // from <0,0,0> to <1,1,0>
     // (aspect ratio 1:1)
     image_map{ gif "E63_Plan_Side1_255.gif" //gamma 1.5
  ...
  scale<1,320/640,1>  translate<-0.5,0,0>  
  //rotate<90,0,0> 

//  adjust to raster
//original loco length: 
scale 10.26 // in meter
translate<0,0.00,-0.01>
no_shadow
