// POV-Ray 3.6 / 3.7 Scene File "Acer_Leaf_01_36.pov"
...
#case (0)
  #declare Camera_Position = < 0.20, 0.00, -3.00> ;  // front view
  #declare Camera_Look_At  = < 0.20, 0.00,  0.00> ;
  #declare Camera_Angle    =  25 ;
#break
#case (1)
  #declare Camera_Position = < 0.90, 1.00, -1.50> ;  // diagonal view
  #declare Camera_Look_At  = < 0.45, 0.18, -0.50> ;
  #declare Camera_Angle    = 28 ;
#break
#case (2)
  #declare Camera_Position = < 0.10, 0.00, -3.00> ;  // right side view
  #declare Camera_Look_At  = < 0.10, 0.00,  0.00> ;
  #declare Camera_Angle    =  25 ;
#break
#case (3)
  #declare Camera_Position = < 0.00, 3.00,  0+0.000> ;  // top view
...
union{
 ...
 text   { ttf "arial.ttf",  "x",  0.15,  0  texture{Tex_Dark}
          rotate Text_Rotate scale 0.75 translate <AxisLenX+0.15,0.2, 0.05> no_shadow }
#end // of #if
#if (AxisLenY != 0)
 object { Axis_(AxisLenY, Tex_Dark, Tex_Light)   rotate< 0,0,  0>}// y-Axis
 text   { ttf "arial.ttf",  "y",  0.15,  0  texture{Tex_Dark}
          rotate <Text_Rotate.x,0,0> scale 0.75 translate <-0.45,AxisLenY+0.20,-0.05> rotate <0,Text_Rotate.y,0> no_shadow }
#end // of #if
#if (AxisLenZ != 0)
 object { Axis_(AxisLenZ, Tex_Dark, Tex_Light)   rotate<90,0,  0>}// z-Axis
 text   { ttf "arial.ttf",  "z",  0.15,  0  texture{Tex_Dark}
          rotate Text_Rotate scale 0.75 translate <-0.55,0.1,AxisLenZ+0.20> no_shadow }
#end // of #if
} // end of union
...
//object{ AxisXYZ( 4.2, 3.0, 5, Texture_A_Dark, Texture_A_Light) scale 0.1}// translate<0,0.3,0>}
...
// Macro for the adjustment of images in POV-Ray version 3.6
...
#declare N_Map = // normal or bump map
 normal{
   bump_map{ jpeg "Acer01_bump.jpg"
        interpolate 2 bump_size 7 once
           } //
       } // --------------------------
//------------------------------------
