// POV-Ray 3.6 / 3.7 Scene File "povtree_001_summer.pov"
...
#declare BOTTOM_COLOR_1=<0.3, 0.4, 0, 0.0, 0.0>;
#declare BOTTOM_COLOR_2=<0.4, 0.5, 0, 0.0, 0.0>;
#declare TOP_COLOR_1=<0.3, 0.5, 0, 0.0, 0.0>;
#declare TOP_COLOR_2=<0.3, 0.6, 0, 0.0, 0.0>;
