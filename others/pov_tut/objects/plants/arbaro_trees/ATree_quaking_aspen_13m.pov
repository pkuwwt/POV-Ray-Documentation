// PoVRay 3.7 Scene File "ATree_quaking_aspen_13m.pov"
...
#case (0)
  #declare Camera_Location = < 0.00, 1.60, -7.00> ;  // front view
...
//-------------------------------------------------------- 
//--------------------------------------------------------------------------
#include "arbaro_trees/quaking_aspen_13m.inc"
//#declare Tree_Height = sassafras_13_height; // ~14.71  ft
//--------------------------------------------------------------------------
// tree with leaves
   union{ 
