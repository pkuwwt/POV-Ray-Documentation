// PoVRay 3.7 Scene File "ATree_ca_black_oak_13m.pov"
...
#case (0)
  #declare Camera_Location = < 0.00, 1.60, -10.50> ;  // front view
  #declare Camera_Look_At  = < 0.00, 2.90,  0.00> ;
...
//-------------------------------------------------------- 
//--------------------------------------------------------------------------
#include "arbaro_trees/ca_black_oak_13m.inc"
//#declare Tree_Height = black_tupelo_15_height; // ~10.60  ft
//--------------------------------------------------------------------------
// tree with leaves
   union{ 
