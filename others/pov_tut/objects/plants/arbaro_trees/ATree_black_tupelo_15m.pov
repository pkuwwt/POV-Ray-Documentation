// PoVRay 3.7 Scene File "ATree_black_tupelo_15m.pov"
...
#case (0)
  #declare Camera_Location = < 0.00, 1.60, -9.30> ;  // front view
  #declare Camera_Look_At  = < 0.00, 3.50,  0.00> ;
...
//-------------------------------------------------------- 
//--------------------------------------------------------------------------
#include "arbaro_trees/black_tupelo_15m.inc"
