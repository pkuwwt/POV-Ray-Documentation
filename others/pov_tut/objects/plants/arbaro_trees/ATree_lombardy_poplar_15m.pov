// PoVRay 3.7 Scene File "ATree_lombardy_poplar_15m.pov"
...
//-------------------------------------------------------- 
//--------------------------------------------------------------------------
#include "arbaro_trees/lombardy_poplar_15m.inc"
//#declare Tree_Height = lombardy_poplar_15_height; // ~22.18  ft
//--------------------------------------------------------------------------
// tree with leaves
   union{ 
          object{ lombardy_poplar_15_stems
                  texture{ Stem_Texture }
                } //------------------------
          object{ lombardy_poplar_15_leaves  
                  double_illuminate
