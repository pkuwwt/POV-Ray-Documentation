// PoVRay 3.7 Scene File "ATree_black_tupelo_13m.pov"
...
#case (0)
  #declare Camera_Location = < 0.00, 1.60, -11.00> ;  // front view
  #declare Camera_Look_At  = < 0.00, 4.20,  0.00> ;
...
//-------------------------------------------------------- 
//--------------------------------------------------------------------------
#include "arbaro_trees/black_tupelo_13m.inc"
//#declare Tree_Height = black_tupelo_13_height; // ~26.72  ft
//--------------------------------------------------------------------------
// tree with leaves
   union{ 
