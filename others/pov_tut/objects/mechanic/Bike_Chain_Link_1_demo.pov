// POV-Ray 3.6 / 3.7 Scene File "Bike_Chain_Link_1_demo.pov"
...
#case (0)
  #declare Camera_Position = <-0.00635, 0.00,-1.00> ;  // front view
  #declare Camera_Look_At  = <-0.00635, 0.00,  0.00> ;
  #declare Camera_Angle    =    3.2 ;
#break
#case (1)
  #declare Camera_Position = < 0.50, 0.50, -0.50> ;  // diagonal view
  #declare Camera_Look_At  = < 0.00, 0.00,  0.00> ;
  #declare Camera_Angle    =   5 ;
#break
#else
  #declare Camera_Position = < 0.00, 0.10, -3.00> ;  // front view
...
// sun -------------------------------------------------------------------
light_source{<1500,1500,-2500> color White*0.9}           // sun light
...
union{
 ...
 text   { ttf "arial.ttf",  "x",  0.15,  0  texture{Tex_Dark}
          scale 0.65 translate <AxisLenX+0.15,0.2,-0.05>}
#end // of #if
#if (AxisLenY != 0)
 object { Axis_(AxisLenY, Tex_Dark, Tex_Light)   rotate< 0,0,  0>}// y-Axis
 text   { ttf "arial.ttf",  "y",  0.15,  0  texture{Tex_Dark}
           scale 0.65 translate <-0.55,AxisLenY+0.20,-0.05>}
#end // of #if
#if (AxisLenZ != 0)
 object { Axis_(AxisLenZ, Tex_Dark, Tex_Light)   rotate<90,0,  0>}// z-Axis
 text   { ttf "arial.ttf",  "z",  0.15,  0  texture{Tex_Dark}
               scale 0.5 translate <-0.75,0.3,AxisLenZ+0.10>}
#end // of #if
} // end of union
...
object{ AxisXYZ( 3.15, 2.5, 0, Texture_A_Dark, Texture_A_Light) scale 0.005}
//-------------------------------------------------- end of coordinate axes


// ground -----------------------------------------------------------------
//---------------------------------<<< settings of squared plane dimensions
#declare RasterScale = 0.01;
