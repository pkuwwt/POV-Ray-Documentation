// POV-Ray 3.6 / 3.7 Scene File "Tube_Stopcock_000_demo.pov"
// author: Friedrich A. Lohmueller, June-2009/Jan-2011
...
#declare Tube_R2   = 0.400;
#declare T_D       = 0.015;
#declare Flange_R1 = 0.650;
#declare Flange_D = 0.050;
#declare Flange_Border_Radius = 0.01;
#declare Tube_L1 = 5;
...
object{ Tube_Round_000 (
                   ...
                   T_D, // T_D, // tube material thickness
                   Tube_R1, // T_R, // radius
                   Flange_R1, // F_R, // flange radius
                   Flange_D, // F_D, // flange thickness
                   Flange_Border_Radius, // FB_R, // Flange_Border_Radius
...
//--------------------------------------------------------------------------------
#include "Tube_Stopcock_000.inc"
//--------------------------------------------------------------------------------
// all together
//--------------------------------------------------------------------------
object{ Tube_Stopcock_000( // total length in z: 4*R1 / in x+: 2*R1 
                           Tube_R1, // R1, // main tube radius:  1 ~ 0.25
                           Tube_R2, // R2, // side tube radius:  1.5 ~ 0.20
                           T_D, // Tube_D, // tube material thickness 
                           0.15, // Blobfactor; // 0.1~0.002 ; maximum = 0.20 !! 
                           0.05, //R_Correction, //   ~  Blobfactor/5
                           0, // Test_End_Cylinders_ON=1; off=0

                           Flange_R1-Tube_R1, // flange radius add
                           Flange_D, // F_D,  // flange thickness
                           Flange_Border_Radius, // FB_R, // Flange_Border_Radius
                           1, // Nuts_ON, // 0 = no nuts but holes; 1 = nuts - no holes
...
//--------------------------------------------------------------------------
union{ 
  object{ Tube_90 rotate<90,90,0 > } 
  object{ Tube_Lin1 rotate<0,-90,0> translate<-Tube_Rmaj1, 0,0*Tube_L1> }
  object{ Tube_Lin1 rotate<0,-90,0> translate<-Tube_Rmaj1, 0,1*Tube_L1> }
  object{ Tube_Lin1 rotate<0,-90,0> translate<-Tube_Rmaj1, 0,2*Tube_L1> }

  translate< -4*Tube_R1,0,Tube_Rmaj1 >
}//

  object{ Tube_Lin1 rotate<0,0,0> translate<  4*Tube_R1 , 0,0*Tube_L1> }
