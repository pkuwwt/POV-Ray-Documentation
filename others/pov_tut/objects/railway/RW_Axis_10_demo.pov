// PoVRay 3.7 Scene File "RW_Axis_10_demo.pov"
...
#declare Camera_0 = camera {/*ultra_wide_angle*/ angle 14      // front view
                            ...
                            look_at   <0.0 , 1.0 , 0.0>}
#declare Camera_1 = camera {/*ultra_wide_angle*/ angle 11 // diagonal view
                            location  <7.0 , 5.0 ,-7.0>
                            right     x*image_width/image_height
                            look_at   <0.0 , 0.47 , 0.0>}
...
*/
//-----------------------------------------------------------------------------------------------------------------------
#include "RW_System/RW_Axis_10.inc" 
//-------------------------------------------------------------------------------------// 
object{ RW_Axis_10(  1.00,  // wheel diameter in meter
                     16,    // Number_Of_Spokes 
                     1,   // Add_Connector_And_Counterweight__,  // Connector with "1" at x+ with 0.5*wheel radius ; without 0 or else
                     1.435, //   gauge in meter
                   ) //----------------
        scale <1,1,1> 
        rotate<0,0,0.00> 
