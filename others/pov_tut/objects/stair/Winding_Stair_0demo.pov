// PoVRay 3.7 Scene File "Winding_Stair_0.pov"
...
#declare Camera0 = camera {ultra_wide_angle angle 60           // front view
                        ...
                        look_at   <0.0 , 2.3 , 0.0>}
#declare Camera1 = camera {ultra_wide_angle angle 17.0           //   far view
                        location  <0.0 , 1.5 ,-25.0>
                        right     x*image_width/image_height
                        look_at   <0.0 , 2.55 , 0.0>}
...
plane{<0,1,0>,1 hollow  
       texture{ pigment{ bozo turbulence 0.76  scale 3
                         color_map { [0.7 rgb <0.20, 0.20, 1.0>]
                                     [0.8 rgb <1,1,1>]
                                     [1.0 rgb <0.5,0.5,0.5>]}
                       }
...
#declare Step_Texture = 
   texture { pigment{ color rgb<1,1,1>*1.20 } 
             finish { phong 0.1} 
           } // end of texture
//---------------------------------------------------------------------------------------
...
object{ Winding_Stair_0(   0.10, //Step___H, // step height                            
                           ...
                           1.30, //Step___Ra, // outer radius of the steps
                           ...
                           Railing_Texture,  
                           Step_Texture   // horizontal texture of steps
                        ) //-----------------------------------------------------------//
        scale <1,1,1>*1
        rotate< 0, 60, 0>
