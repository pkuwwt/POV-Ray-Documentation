...
#break
#case (1)
  #declare Camera_Location = <38.00,  1.60, -15.00> ;  // 
  #declare Camera_Look_At  = <-2.50, 14.00,  12.00 > ;
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{< -1500,2500,-1500> color rgb<1,1,1>*0.9}                // sun 
...
object{ BusinessBuilding_000( 
        ...
        scale <1,1,1>*1
        rotate<0, 0,0> 
        translate<3*(4*1.00++0.35)+0.35,0.00,2*(4*1.00++0.35)> 
      } //---------- 
//-------------------------------------------------------------------------------------//
//-------------------------------------------------------------------------------------//
