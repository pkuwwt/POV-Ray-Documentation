// PoVRay 3.6 / 3.7 Scene File "Window_2_demo.pov"
...
union{ 
 difference{ 
  ...
  object { Window_2_Hole translate Windows_Position_1  texture{Wall_Texture}}
  }

 object { Window_2_Hole translate Windows_Position_2  texture{pigment{color rgb<1,1,1>*1.2 transmit 0.5}}}

 object{ Window_2 ( 0.30 ) // Window_Open: 0= down closed; 1 = up opened  
