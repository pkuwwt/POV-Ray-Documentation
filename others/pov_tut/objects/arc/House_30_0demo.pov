// PoVRay 3.7 Scene File "House_30_0demo.pov"
...
#declare Camera_1 = camera {/*ultra_wide_angle*/ angle 50   // diagonal view
                            location  <4.5 , 2.5 ,-4.0>
                            right     x*image_width/image_height
                            look_at   <0.5 , 1.35 , 1.0>}
...
#declare Wall_Texture_Outside = 
      texture { pigment{ color rgb< 0.75, 0.55, 0.40>*0.8}               
                normal { pigment_pattern{ gradient y  scallop_wave 
                                           color_map {[0, rgb 0.2]
                                                      [1, rgb 0.8]}
                                           scale 0.10}
                         0.3 translate<0,-0.11,0>}
                finish { phong 0.1}
              } // end of texture
//--------------------------------------------------------                                 
...
// layered texture!!!
      texture { pigment{ color rgb<1,1,1>*0.65} //Scarlet*1.3
                normal { gradient z scallop_wave scale<1,1,0.25>} 
                finish { phong 1}
              } // end of texture
...
#declare Base_Texture = 
         texture{ pigment{ color rgb< 0.75, 0.65, 0.60>*1.2}
                  normal { bumps 0.5 scale 0.005 }
                  finish { phong 0.0}}
//----------------------------------------------------------------------------------------
#//---------------------------------------------------------------------------------------
#include "House_30_0.inc" 
//-------------------------------------------------------------------------------------// 
object{ House_30_0( 2.00 , // Half_House_Width_X, // >= 2.00
                    4.00 , // Total_House_Width_Z,// >= 2.00
                    3.20 , // House_Height_Y,     // >= 2.00
                    20   , // Roof___Angle, // ca. 10 ~ 60 degrees
                    // door and windows open/closed  
                    0.5 , //Door_Open_Frontside_1,   left: 0=closed  ~ 1=open 
                    0.7 , //Window_Open_Frontside_2,right: 0=closed  ~ 1=open 
                    0.3 , //Window_Open_Backside_1,  left: 0=closed  ~ 1=open 
                    0.0 , //Window_Open_Backside_2, right: 0=closed  ~ 1=open 
                    0.7 , //Window_Open_RightSide_1, back: 0=closed  ~ 1=open 
                    0.2 , //Window_Open_RightSide_2,front: 0=closed  ~ 1=open 
                    0.3 , //Window_Open_LeftSide_1,  back: 0=closed  ~ 1=open 
                    1.0 , //Window_Open_LeftSide_2, front: 0=closed  ~ 1=open 
                    // textures  
