// POV-Ray 3.6/3.7 Scene File "Star_1_demo.pov"
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{<1500,-2500,-1500> color White*1}
// sky -------------------------------------------------------------------
...
object{ AxisXYZ( 4.5*2, 4.5*2, 4.5*2, Texture_A_Dark, Texture_A_Light) scale 0.125  translate<0,1,0>}
...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
object{ Star_1 ( 8 ) // Number_of_Rays, )
        scale 0.5
        texture { pigment{ color rgb<1,0.76,0.25>}
                  normal { crackle 1.0 scale 0.05 turbulence 0.5}
