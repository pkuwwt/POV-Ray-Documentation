// POV-Ray 3.6/3.7 Scene File "Round_Mace_Torus_demo_1.pov"
...
#break
#case (1)
  #declare Camera_Position = < -4.00, 2.57, -5.00> ;  // diagonal view
  #declare Camera_Look_At  = < 0.00, 0.57,  0.00> ;
...
object{ AxisXYZ( 3, 6, 4.5, Texture_A_Dark, Texture_A_Light) scale 0.2  translate <0,0,0> }
...
//-------------------------------------------------------------------------------------//
object{ Round_Mace_Torus (  0.50, // R_main,    // mace top radius (r_major)
                            0.05, // R_Border,  // border radius (r_minor)
                            0.60, // H_main,    // height y of main circle center
                            0.25, // R_base,    // basic half width in x of the mace  >= border radius and < mace top radius 

                            1 , // Shape_filled_On, // 0 = non, 1 = filled 
                            0  // Merge_On - for transparent materials
                          ) // -------------------------------------------------------//
...
/*
        material{   //-----------------------------------------------------------
          texture{ pigment{ rgbf <0.98, 0.98, 0.98, 0.69> }
