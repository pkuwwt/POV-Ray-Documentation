// POV-Ray 3.6 / 3.7 Scene File "Cone_Flatted.pov"
...
#break
#case (1)
  #declare Camera_Position = < 5.00, 5.50,-5.00> ;  // front view
...
sky_sphere{ pigment{ gradient <0,1,0>
                     color_map{ [0   color rgb<1,1,1>         ]//White
                                [0.3 color rgb<0.24,0.34,0.56>*0.55]//~Navy
                                [0.7 color rgb<0.24,0.34,0.56>*0.55]//~Navy
...
object{ AxisXYZ( 4.75, 4.75, 7, Texture_A_Dark, Texture_A_Light) scale 0.25}
