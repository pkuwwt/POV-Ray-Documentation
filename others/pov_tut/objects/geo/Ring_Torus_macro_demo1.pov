// POV-Ray 3.6 / 3.7 Scene File "Ring_Torus_macro1_demo.pov"
...
#break
#case (1)
  #declare Camera_Location = < 7.00,4.50, -8.00> ;  // diagonal view
  #declare Camera_Look_At  = < 0.25, 0.00,  0.00> ;
  #declare Camera_Angle    =  45 ;
#break
#case (2)
...
object{ AxisXYZ( 2*4.25,2* 2.5,2* 8.0, Texture_A_Dark, Texture_A_Light) scale 0.5 }
...
//-----------------------------------------------------------------//////
object{ Ring_Torus (3.00, 1.00, 0.04 // R_major, R_minor, R_Wire,
                     24, 36 // Number_Rings_horizontal, Number_Rings_vertical
                   ) //-----------------------------------------------------
        texture{ // Polished_Chrome 
                 pigment{ color rgb< 1, 1, 1> } //  color White
                 // normal { bumps 0.5 scale 0.05 }
                 finish { phong 1 reflection 0.20}
                } // end of texture 
       //texture{ pigment {Red} finish {phong .5 reflection .75}
       rotate<0,0,0> 
       //  translate<0,1.05,0>  
      }
//-----------------------------------------------------------------//////
