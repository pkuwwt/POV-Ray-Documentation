// PoVRay 3.7 Scene File "Track_Chain_0.pov"
...
object{ AxisXYZ( 5.15, 3.5, 5, Texture_A_Dark, Texture_A_Light) scale 0.25}
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
object{ Track_Chain_0( 3.50, // Chain_Length > 4*Chain_Radius; total legth in x
                       0.30, // Chain_Radius,  // half total height in y 
                       0.65, // Chain_Depth__,   // depth in z 
                       Chain_Color,   // base color of the chains  
                       Wheel_Texture   //  texture of the wheels  
                     ) //----------------------------------------- 
        scale <1,1,1> 
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
object{ Track_Chain_0( 0.60, // Chain_Length > 4*Chain_Radius; total legth in x
                       0.20, // Chain_Radius,  // half total height in y 
                       0.20, // Chain_Depth__,   // depth in z 
                       Chain_Color,   // base color of the chains  
                       Wheel_Texture   //  texture of the wheels  
                     ) //----------------------------------------- 
        scale <1,1,1> 
