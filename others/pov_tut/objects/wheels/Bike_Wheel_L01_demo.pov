// POV-Ray 3.7 include file "Bike_Wheel_L01_demo.pov"
...
#case (0)
  #declare Camera_Location = < 0.00, 1.00,-10.00> ;  // front view
  #declare Camera_Look_At  = < 0.00, 1.00,  0.00> ;
  #declare Camera_Angle    =  25 ;
#break
#case (1)
  #declare Camera_Location = < 1.00, 1.50, -2.00> ;  // diagonal view
  #declare Camera_Look_At  = < 0.05, 0.43,  0.00> ;
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{<-500,2000,-2000> color rgb<1,1,1>*0.8}                // sun
...
object{ AxisXYZ(  5 , 8.50, 17.00, Texture_A_Dark, Texture_A_Light) scale 0.1 }
...
// ---------------------------------------- optional textures:
//-------------------------------------------------------------------------
#declare Tire_Texture_Base  =  // Grund_Reifen-Textur
 texture { pigment{color rgb<1,1,1>*0.1}
           normal {bumps 0.5 scale 0.05}
           finish {ambient 0.15 diffuse 0.85 phong 0.1}
         } // end of texture
#declare Rim_Texture = //       Felgen-Textur
 texture { // pigment{color rgb<1,1,1>*0.25}
           Polished_Chrome
           finish { phong 1}
         } // end of texture
//-------------------------------------------------------------------------
#include "Bike_Wheel_L01.inc"
//-------------------------------------------------------------------------
//#macro Bike_Wheel_L01(Wheel__R, Wheel__Rotation)
object{ Bike_Wheel_L01(0.40, 0)  
