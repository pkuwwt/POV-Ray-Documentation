// POV-Ray 3.7 include file "Wheel_L01_demo.pov"
...
#case (1)
  ...
  #declare Camera_Look_At  =  < 0.05, 0.47,  0.00> ;
...
object{ AxisXYZ( 2.50, 4.50, 9.00, Texture_A_Dark, Texture_A_Light) scale 0.2 }
...
//---------------------------------------------------------------------- 
object{ Wheel_L02 ( 0*clock*360/18  ) // in degrees; 
