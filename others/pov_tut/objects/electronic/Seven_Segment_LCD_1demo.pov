// POV-Ray 3.6 / 3.7 Scene File "Seven_Segment_LCD_01.pov"
...
#case (1)
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Camera_Position = < 1.80, 0.20,-2.50> ;  // front view
  #declare Camera_Look_At  = < 0.80, 0.75,  0.00> ;
...
object{ AxisXYZ( 9.45, 8.3, 6, Texture_A_Dark, Texture_A_Light) scale 0.2}
...
#declare Seg_D = 1.00;
//----------------------------------------------------------------------------
object{ Seven_Segment_LCD( -1, // 0~9, integer !!! SS_Number, 
                           10, // 0~10, SS_Angle, 
...
//----------------------------------------------------------------------------
//----------------------------------------------------------------------------
object{ Seven_Segment_LCD( 6, // 0~9, integer !!! SS_Number, 
                           10, // 0~10, SS_Angle, 
                           //< 1.5, 10, 1.40>, // SS_Background_Scale, SS_Angle=0  
                           < 1.75, 5 , 1.40>,// for SS_Angle=10
                           Active_Texture, // SS_Light_Color, 
