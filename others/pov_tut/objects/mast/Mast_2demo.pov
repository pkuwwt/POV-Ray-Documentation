// PoVRay 3.7 Scene File "Mast_2demo.pov"
...
#declare Look_At_1 = < 0.00, 12.50, 0.00>; 
...
object{ Mast_2(   8, // number of segments * segment height = total height 
                  ...
                  2       // End___Type  0 = both complete triangular,
        ...
        scale <1,1,1>*1
        rotate<90,0,0> 
        translate<-2.50,14.65, -1.00>}
//-------------------------------------------------------------------------------------//
//---------------------------------------------------------------------------------------
object{ Mast_2(   7, // number of segments * segment height = total height 
                  2.00, // segment_height
                  1.00, // half width (outline!)
                  0.050,  // R1, tube main radius
                  0.025,  // R2, tube diagonals radius 
