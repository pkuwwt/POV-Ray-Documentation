// POV-Ray 3.6 / 3.7 Scene File "Steel_Lattice_Tower_1_demo.pov"
...
#case (1)
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Camera_Position = < 10.00, 10.00,-6.00> ;  // diagonal view high
  #declare Camera_Look_At  = < 0.00,  3.70,  0.00> ;
  #declare Camera_Angle    =  33;
#break
#else
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Camera_Position = < 0.00, 1.00,-20.00> ;  // front view far
  #declare Camera_Look_At  = < 0.00, 1.00,  0.00> ;
  #declare Camera_Angle    =  65 ;
#break
...
//--------------------- drawing of 3 Axes --------------------------------
#declare Text_Rotate = <0,-60,0>; //  <10,-45,0>;
union{
#if (AxisLenX != 0)
 object { Axis_(AxisLenX, Tex_Dark, Tex_Light)   rotate< 0,0,-90>}// x-Axis
 text   { ttf "arial.ttf",  "x",  0.15,  0  texture{Tex_Dark}
          rotate Text_Rotate scale 0.75  translate <AxisLenX+0.15,0.4,-0.05> no_shadow }
#end // of #if
#if (AxisLenY != 0)
 object { Axis_(AxisLenY, Tex_Dark, Tex_Light)   rotate< 0,0,  0>}// y-Axis
 text   { ttf "arial.ttf",  "y",  0.15,  0  texture{Tex_Dark}
          rotate <Text_Rotate.x,0,0> scale 0.55 translate <-0.45,AxisLenY+0.20,-0.05> rotate <0,Text_Rotate.y,0> no_shadow }
#end // of #if
#if (AxisLenZ != 0)
 object { Axis_(AxisLenZ, Tex_Dark, Tex_Light)   rotate<90,0,  0>}// z-Axis
 text   { ttf "arial.ttf",  "z",  0.15,  0  texture{Tex_Dark}
          rotate Text_Rotate scale 0.75 translate <-0.75,0.4,AxisLenZ+0.10> no_shadow }
#end // of #if
} // end of union
...
object{ AxisXYZ( 3.0, 7.9, 7.0, Texture_A_Dark, Texture_A_Light)}
...
//--------------------------------------------------------------------------
//--------------------------------------------------------------------------
       // translate<0, 00*Step_1*N,0>  scale 1