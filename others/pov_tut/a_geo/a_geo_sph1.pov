// POV-Ray 3.7 Scene File "a_geo_sph1.pov"
...
object{ Vector( o,  M2, Rl)          pigment{ color rgb<0.6,1,0> } }
object{ Vector( M2, M2+<Rx,0,0>, Rl) pigment{ color rgb<0.6,1,0> } }
object{ Vector( M2, M2+<0,Ry,0>, Rl) pigment{ color rgb<0.6,1,0> } }
object{ Vector( M2, M2+<0,0,Rz>, Rl) pigment{ color rgb<0.6,1,0> } }
torus{ 1, Rl/Rx                 scale<Rx,0,Rz>  translate M2 pigment{ color rgb<0.6,1,0> } }
torus{ 1, Rl/Rx rotate< 90,0,0> scale<Rx,Ry,0>  translate M2 pigment{ color rgb<0.6,1,0> } }
torus{ 1, Rl/Rx rotate< 0,0,90> scale<0,Ry,Rz>  translate M2 pigment{ color rgb<0.6,1,0> } }
