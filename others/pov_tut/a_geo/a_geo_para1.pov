...
#declare P  = < 4.0, 0.0,-1.5>;  
#declare Q  = < 4.0, 1.5, 2.5>;  
#declare R  = <-1.5, 1.0,-4.0>;
#declare S  = < 2.0, 1.0,-1.0>;
...
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
//Parallelepiped_by_Corners(Corner_V0, Corner_V1, Corner_V2, Corner_V3, R_Base, R_Ang, Filled)
object{ Parallelepiped_by_Corners(P,Q,R,S, Rl, Rp, 0) pigment{ color rgb<0.6,1,0.2> }}
object{ Parallelepiped_by_Corners(P,Q,R,S, 0, 0, 1) pigment{ color Green transmit 0.5 }}


text { ttf "arial.ttf", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 0.7, 0.1,-0.2> pigment{ color Red } no_shadow }
...
text { ttf "arial.ttf", "R",0.1,0 
       scale 0.5 rotate<20,-45,0> translate R+<-0.7,-0.5,-0.3>  pigment{ color Red } no_shadow } 
text { ttf "arial.ttf", "S",0.1,0 
       scale 0.5 rotate<20,-45,0> translate S+<-0.2,0.3, 0.0>  pigment{ color Red } no_shadow }
//------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------- end
