// PoVRay 3.7 Scene File "a_geo_03.pov"
//
...
#declare A  = < 4.0, 2.0, 1.5>;  
#declare B  = < 1.5, 0.0,-4.0>;  
#declare C  = < 0.0, 1.0, 1.5>;
...
object{ Wire_Box( o, A, Rl/2, 0) pigment{ color Yellow }}
...
object{ Wire_Box( o, B, Rl/2, 0) pigment{ color Yellow }}
...
object{ Wire_Box( o, C, Rl/2, 0) pigment{ color Yellow }}
