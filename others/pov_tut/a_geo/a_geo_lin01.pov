// PoVRay 3.7 Scene File "a_geo_lin01.pov"
...
Orange rgb<1,0.5,0>;  Cyan rgb<0,1,1>      ; Magenta rgb<1,0,1> ;
...
text { ttf "arial.ttf", "Q",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+<-0.1,0.3,-0.0> pigment{ color Red } no_shadow }
...
// vector - Vektor - vettore  
 ...
 object{ Distance_Marker ( P,R, Rl) pigment{ color rgb<0.7,0.0,1.0> }  }
 object{ Distance_Marker ( P,Q, Rl) pigment{ color rgb<0.7,0.0,1.0> }  }
 object{ Distance_Marker ( Q,R, Rl) pigment{ color rgb<0.7,0.0,1.0> }  }
