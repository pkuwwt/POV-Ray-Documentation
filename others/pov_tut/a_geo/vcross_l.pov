// POV-Ray 3.7 Scene File "vcross_l.pov"
...
text { ttf "ARIAL.TTF", "V1",0.1,0 
       scale 0.4 rotate<20,-45,0> translate V1/2+<0.0,0.3, 0.0> pigment{ color Red } no_shadow}

text { ttf "ARIAL.TTF", "V2",0.1,0 
       scale 0.4 rotate<20,-45,0> translate V2/2+<0.0,0.8,-1.0> pigment{ color Orange } no_shadow}


text { ttf "ARIAL.TTF", "V1 x V2",0.1,0 
       scale 0.4 rotate<20,-45,0> translate vcross(V1,V2)/2+<0.0,0.8,-2.5> pigment{ color YellowGreen } no_shadow}
