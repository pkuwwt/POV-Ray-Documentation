// POV-Ray 3.7 Scene File "a_geo_con1.pov"
...
cone  { M1,R1, M2,R2   pigment{ color Red*0.7 transmit 0.5 }}
sphere{ M1, Rp                                                           pigment{ color Red } }
object{ Vector( o, <R1,0,0>, Rl/2) Reorient_Trans(y, M2-M1) translate M1 pigment{ color Red } }
torus { R1,Rl/2                    Reorient_Trans(y, M2-M1) translate M1 pigment{ color Red*0.8 } }

sphere{ M2, Rp/2                                                          pigment{ color Red } }
//object{ Vector( o, <R2,0,0>, Rl/2) Reorient_Trans(y, M2-M1) translate M2 texture{ T_Red } }
//torus{  R2,Rl/2                    Reorient_Trans(y, M2-M1) translate M2 texture{ T_Orange } }
                
//----------------------------------------------------------------------------------

cone  { M3, R3, M4, R4   pigment{ color Yellow transmit 0.6 }}
sphere{ M3, Rp                                                            pigment{ color Red } }
object{ Vector( o, <R3,0,0>, Rl/2) Reorient_Trans(y, M4-M3) translate M3  pigment{ color Red } }
torus { R3, Rl/2                    Reorient_Trans(y, M4-M3) translate M3 pigment{ color Orange } }

sphere{ M4, Rp/2                                                          pigment{ color Red } }
object{ Vector( o, <R4,0,0>, Rl/2) Reorient_Trans(y, M4-M3) translate M4  pigment{ color Red } }
torus{ R4, Rl/2                    Reorient_Trans(y, M4-M3) translate M4  pigment{ color Orange } }

//object{ Distance_Marker(M3, M4, Rl/2) translate < R3,0,0> texture{ T_Yellow}}
