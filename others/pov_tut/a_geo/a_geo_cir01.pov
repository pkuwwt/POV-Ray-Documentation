// POV-Ray 3.7 Scene File "a_geo_cir01.pov"
...
text { ttf "arial.ttf", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+<-0.1,0.4, 0.2> pigment{ color Red*0.7 } no_shadow}
...
#declare Nt =  Triangle_Normal(P,Q,R);
 ...
 object{ Vector( Mo,P, Rl*2/3) pigment{ color Red*0.5 }  }
 object{ Vector( Mo,Q, Rl*2/3) pigment{ color Red*0.5 }  }
 object{ Vector( Mo,R, Rl*2/3) pigment{ color Red*0.5 }  }

 object{ Vector( o,Mo, Rl) pigment{ color Red }  }
 sphere{ Mo, Rp            pigment{ color Red }  }
text { ttf "arial.ttf", "M",0.1,0 
       scale 0.45 rotate<20,-45,0> translate Mo+<-0.2,0.3,-0.0> pigment{ color Red*0.7 } no_shadow }

text { ttf "arial.ttf", "r",0.1,0 
       scale 0.45 rotate<20,-45,0> translate Mo+< 1.2,-0.3,-0.7> pigment{ color Red*0.5 } no_shadow }

 object{ Circle_Line_out ( P,Q,R, Rl) pigment{ color Orange }} 
 object{ Circle_Disc_out ( P,Q,R )    pigment{ color Yellow transmit 0.5 }} 
 
 triangle{ P,Q,R  translate<0,0.01,0> pigment{ color rgb<1,0.6,0> transmit 0.5 }}                 
...
text{ ttf "ARIAL.TTF"  concat( "M (",vstr(3, Mo,",",5, 2 ),")") , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate <0,-1.0,0>
      pigment{ color Magenta*0.7 }  no_shadow }

text{ ttf "ARIAL.TTF"  concat( "r = ",str( Ro, 5, 3 )) , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate < 0,-1.4,0>
      pigment{ color Magenta*0.7 }  no_shadow }
 
text{ ttf "ARIAL.TTF"  concat( "|PQR| = ", str( Triangle_Circum(P,Q,R), 5, 2 ))  , 0.1, 0       
