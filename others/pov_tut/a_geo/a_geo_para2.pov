// POV-Ray 3.7 Scene File "a_geo_tetra1.pov"
...
#declare V1  = <-1.5, 1.0, 5.0>;  
#declare V2  = <-5.0, 1.0,-3.0>;
#declare V3  = <-2.0, 1.5, 0.5>;

object{ Show_Yxz( P, Rl/2)    pigment{ color Yellow }}
object{ Show_Yxz( P+V1, Rl/2) pigment{ color Yellow }}
object{ Show_Yxz( P+V2, Rl/2) pigment{ color Yellow }}
object{ Show_Yxz( P+V3, Rl/2) pigment{ color Yellow }}
//------------------------------------------------------------------------------------
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
object{ Parallelepiped_by_Edges(P,V1,V2,V3, 0, 0, 1)     pigment{ color rgb<0.5,0.3,1> transmit 0.5 }}
object{ Parallelepiped_by_Edges(P,V1,V2,V3, Rl/2, Rp, 0) pigment{ color Red*0.8 }}

object{ Vector( o,   P, Rl) pigment{ color rgb<0.6,1,0> }  }
object{ Vector( P,P+V1, Rl) pigment{ color rgb<0.6,1,0> }  }
object{ Vector( P,P+V2, Rl) pigment{ color rgb<0.6,1,0> }  }
object{ Vector( P,P+V3, Rl) pigment{ color rgb<0.6,1,0> }  }

 
text { ttf "arial.ttf", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 0.5, 0.3,-0.1>     pigment{ color Green*0.5 } no_shadow }
text { ttf "arial.ttf", "V1",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+V1/2+< 0.4,0.3, 0.0> pigment{ color Green*0.5 } no_shadow }
text { ttf "arial.ttf", "V2",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+V2/2+<-0.5,0.1,-1.3> pigment{ color Green*0.5 } no_shadow } 
text { ttf "arial.ttf", "V3",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+V3/2+< 0.0,0.3, 0.0> pigment{ color Green*0.5 } no_shadow }
