// POV-Ray 3.7 Scene File "a_geo_e2.pov"
...
object{ AxisXYZ( 7.0, 3.5, 8.0, Texture_A_Dark, Texture_A_Light) no_shadow} // <<<<<<<<<<<<<<<<< adapt the axes here !!!
...
#declare P  = < 2.0, 0.0, 2.0>;  
#declare N1 = < 0.0, 2.0,-2.0>;  


#declare Q  = < -1.0, 1.0,-2.0>;  
#declare N2 = < 1.0, 2, 0.5>;  
//------------------------------------------------------------------------------------
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
...
text { ttf "arial.ttf", "Np",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+N1+< 0.1,0.3,-0.6>  pigment{ color rgb<0.6,1,0> } no_shadow}
sphere{ Q, Rp  pigment{ color Red*0.5 } }
object{ Show_Yxz( Q, Rl/2) pigment{ color Yellow }}
text { ttf "arial.ttf", "Q",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+< 0.5,-0.4,-0.3> pigment{ color Red*0.5 } no_shadow}
text { ttf "arial.ttf", "Nq",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+N2+< 0.5,-0.2,-0.3> pigment{ color Magenta*0.5 } no_shadow}
//------------------------------------------------------------------------------------
 object{ Vector( o,P, Rl)    pigment{ color Green*0.5 } no_shadow }
 object{ Vector( P,P+N1, Rl)  pigment{ color rgb<0.6,1,0> } no_shadow }

 object{ Plane_Nor( vnormalize(N1),sqrt(2), <-6,-1,-2>, <4,2 ,4>) pigment{ color rgb<0.6,1,0> transmit 0.5 }}

 object{ Vector( o,Q, Rl) pigment{ color Red*0.5 }  }
 object{ Vector( Q,Q+N2, Rl) pigment{ color Magenta*0.5 } no_shadow }

 object{ Plane_NoP( N2, Q, <-6,-1,-4>, <6,2 ,4>) pigment{ color Magenta*0.5 transmit 0.4 } no_shadow}
