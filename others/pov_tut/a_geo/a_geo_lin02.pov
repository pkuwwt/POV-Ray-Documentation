...
#macro Axis_( AxisLen, Dark_Texture,Light_Texture) 
 union{
    cylinder { <0,-AxisLen-2,0>,<0,AxisLen,0>,0.05
...
#declare P  = < 2.0, 0.0,-3.0>;  
#declare Q  = < 3.0, 2.0, 3.0>;  
#declare R  = <-4.0, 3.0,-1.0>;

// Projections on xz plane
#declare Pxz  = < 2.0, 0.0,-3.0>;  
#declare Qxz  = < 3.0, 0.0, 3.0>;  
#declare Rxz  = <-4.0, 0.0,-1.0>;

//------------------------------------------------------------------------------------
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
sphere{ P, Rp  pigment{ color Red*0.5 } }
sphere{ Q, Rp  pigment{ color Red*0.5 } }
sphere{ R, Rp  pigment{ color Red*0.5 } }
object{ Show_Yxz( Q, Rl/2) pigment{ color Yellow }}
object{ Show_Yxz( R, Rl/2) pigment{ color Yellow }}

text { ttf "arial.ttf", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+<-0.2,0.0,-0.5> pigment{ color Red } no_shadow}

text { ttf "arial.ttf", "Q",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+< 0.1,0.2,-0.0> pigment{ color Red } no_shadow }

text { ttf "arial.ttf", "R",0.1,0 
       scale 0.5 rotate<20,-45,0> translate R+<-0.2,0.3,-0.3> pigment{ color Red } no_shadow }

//------------------------------------------------------------------------------------
sphere{ Qxz, Rp  pigment{ color Red*0.7 } }
sphere{ Rxz, Rp  pigment{ color Red*0.7 } }

text { ttf "arial.ttf", "Qxz",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Qxz+< 0.10,0.2,-0.0> pigment{ color Red*0.3 } no_shadow }

text { ttf "arial.ttf", "Rxz",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Rxz+<-0.2,0.3,-0.3>  pigment{ color Red*0.3 } no_shadow }
//------------------------------------------------------------------------------------


// vector - Vektor - vettore  
...
// straight line PR  - Strecke PR
 cylinder{ P,Q,  Rl*0.8  pigment{ color Red*0.7 }  }
 cylinder{ P,R,  Rl*0.8  pigment{ color Red*0.7 }  }

// Projections on xz plane
 cylinder{ Pxz,Qxz,  Rl*0.8  pigment{ color Red*0.7 }  }
 cylinder{ Pxz,Rxz,  Rl*0.8  pigment{ color Red*0.7 }  }



 
// line QR  -  Gerade QR 
 cylinder{ Q-10*(R-Q), R+10*(R-Q), Rl*0.8  pigment{ color Green*0.5 }  }

 cylinder{ Qxz-10*(Rxz-Qxz), Rxz+10*(Rxz-Qxz), Rl*0.8  pigment{ color rgb<0,1,1>*0.5 }  }
