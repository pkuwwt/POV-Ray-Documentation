// POV-Ray 3.7 Scene File "a_geo_calc02.pov"
...
object{ AxisXYZ( 4.0, 4.0, 5.0, Texture_A_Dark, Texture_A_Light)} // <<<<<<<<<<<<<<<<< adapt the axes here !!!
...
//------------------------------------------------------------------------------------
#declare H = 3.00;   
#declare R1_Cone = 2.00;  
#declare R2_Cone = 1.00;  
...
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
cone { P, R1_Cone, Q, R2_Cone pigment{ color Yellow transmit 0.6 }  } 
sphere{ P, Rp  pigment{ color Red } }
sphere{ Q, Rp  pigment{ color Red } }


text { ttf "ARIAL.TTF", "r1",0.1,0 
       scale 0.4 rotate<20,-45,0> translate P+<-0.1,0.4,-0.7> pigment{ color Red } no_shadow}

text { ttf "ARIAL.TTF", "r2",0.1,0 
       scale 0.4 rotate<20,-45,0> translate Q+<-0.1,0.5,-0.7> pigment{ color Red } no_shadow }

text { ttf "ARIAL.TTF", "h",0.1,0 
       scale 0.6 rotate<20,-45,0> translate <-1.5,1.1,-2.0> pigment{ color Green*0.5 } no_shadow }

//------------------------------------------------------------------------------------
union{
 object{ Vector( o,<R1_Cone,0,0>, Rl) pigment{ color Red }  }
 object{ Vector( o,<R2_Cone,0,0>, Rl) pigment{ color Red }  translate Q }

 cylinder { Q, Q+<R1_Cone*1.2,0,0>, Rl/2  pigment{ color Yellow } }
 cylinder { P, P+<R1_Cone*1.2,0,0>, Rl/2  pigment{ color Yellow } }

 torus{  R1_Cone, Rl/2          pigment{ color Orange }} 
 torus{  R2_Cone, Rl/2          pigment{ color Orange } translate Q} 

 object{ Distance_Marker( P,Q, Rl) pigment{ color Green*0.7 }  translate<R1_Cone,0,0>}

rotate<0, 135,0> }
//------------------------------------------------------------------------------------
// calculate :

text{ ttf "ARIAL.TTF"  concat( "h  = ",str( Q.y, 4, 2 )) , 0.1, 0       
       scale 0.35 rotate<20,-43,0> translate Q+<R1_Cone,0,0>+< 1,0.0,0>
      pigment{ color  Magenta*0.5 }  no_shadow }
text{ ttf "ARIAL.TTF"  concat( "r1 = ",str( R1_Cone, 4, 2 )) , 0.1, 0       
       scale 0.35 rotate<20,-43,0> translate Q+<R1_Cone,0,0>+< 1,-0.4,0>
      pigment{ color  Magenta*0.5 }  no_shadow }
text{ ttf "ARIAL.TTF"  concat( "r2 = ",str( R2_Cone, 4, 2 )) , 0.1, 0       
       scale 0.35 rotate<20,-43,0> translate Q+<R1_Cone,0,0>+< 1,-0.8,0>
      pigment{ color  Magenta*0.5 }  no_shadow }

text{ ttf "ARIAL.TTF"  concat( "V = ", str( 1/3*pi*H*(R1_Cone*R1_Cone - R2_Cone*R2_Cone), 5, 2 ))  , 0.1, 0       
      scale 0.45   rotate<20,-43,0> translate <R1_Cone,H,0>+< 1,-1.4,0>
