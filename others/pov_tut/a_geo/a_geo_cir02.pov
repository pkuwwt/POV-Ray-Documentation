// POV-Ray 3.7 Scene File "a_geo_cir02.pov"
...
#declare P  = < 4.0, 0.0,-2.0>;  
#declare Q  = < 3.0, 2.0, 3.0>;  
#declare R  = <-2.0, 2.0,-1.0>;
//------------------------------------------------------------------------------------
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
sphere{ P, Rp  pigment{ color Red*0.7 } }
sphere{ Q, Rp  pigment{ color Red*0.7 } }
sphere{ R, Rp  pigment{ color Red*0.7 } }
object{ Show_Yxz( Q, Rl/2) pigment{ color Yellow }}
object{ Show_Yxz( R, Rl/2) pigment{ color Yellow }}

text { ttf "arial.ttf", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 0.5,0.1, 0.1> pigment{ color Red*0.7 } no_shadow}

text { ttf "arial.ttf", "Q",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+<-0.1,0.3,-0.0> pigment{ color Red*0.7 } no_shadow }

text { ttf "arial.ttf", "R",0.1,0 
       scale 0.5 rotate<20,-45,0> translate R+<-0.2,0.3,-0.3> pigment{ color Red*0.7 } no_shadow }

//------------------------------------------------------------------------------------
#declare Mo =  Triangle_M_out (P,Q,R);
#declare Ro =  Triangle_R_out (P,Q,R);

#declare Nt =  Triangle_Normal(P,Q,R);

#declare Mi =  Triangle_M_in (P,Q,R);
#declare Ri =  Triangle_R_in (P,Q,R);

 object{ Vector( P,Q, Rl) pigment{ color Green*0.5 }  }
 object{ Vector( Q,R, Rl) pigment{ color Green*0.5 }  }
 object{ Vector( R,P, Rl) pigment{ color Green*0.5 }  }

 cylinder{ Mi,P, Rl/3  pigment{ color Green*0.5 }  }
 cylinder{ Mi,Q, Rl/3  pigment{ color Red*0.5 }  }
 cylinder{ Mi,R, Rl/3  pigment{ color Red*0.5 }  }

#declare Pr = vnormalize(P-Mi)*Ri; 
#declare Qr = vnormalize(Q-Mi)*Ri; 
#declare Rr = vnormalize(R-Mi)*Ri; 
 object{ Vector( Mi,Mi+Pr, Rl) pigment{ color Red*0.5}  }
 object{ Vector( Mi,Mi+Qr, Rl) pigment{ color Red*0.5}  }
 object{ Vector( Mi,Mi+Rr, Rl) pigment{ color Red*0.5}  }


 object{ Vector( o,Mi, Rl) pigment{ color Red*0.7 }  }
 sphere{ Mi, Rp            pigment{ color Red*0.7 }  }
text { ttf "arial.ttf", "M",0.1,0 
       scale 0.45 rotate<20,-45,0> translate Mi+<-0.2,0.3,-0.0> pigment{ color Red*0.7 } no_shadow }

text { ttf "arial.ttf", "r",0.1,0 
       scale 0.45 rotate<20,-45,0> translate Mi+< 0.7,-0.2,-0.3> pigment{ color Red*0.5 } no_shadow }

 object{ Circle_Line ( Mi, Ri, Rl, Nt) pigment{ color Orange }} 
 object{ Circle_Disc ( Mi, Ri, Nt)     pigment{ color Yellow transmit 0.5}}

 triangle{ P,Q,R  translate<0,0.01,0>  pigment{ color rgb<0.6,1,0> transmit 0.5 }  }                 
...
text{ ttf "ARIAL.TTF"  concat( "M =(",vstr(3, Mi,",",5, 2 ),")") , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate <0,-1.0,0>
      pigment{ color Magenta*0.7 }  no_shadow }

text{ ttf "ARIAL.TTF"  concat( "r = ",str( Ri, 5, 3 )) , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate < 0,-1.4,0>
      pigment{ color Magenta*0.7 }  no_shadow }
 
text{ ttf "ARIAL.TTF"  concat( "A = ",str( Triangle_Area(P,Q,R), 4, 2 )) , 0.1, 0       
       scale 0.3 rotate<20,-44,0>  translate  < 0,-1.8,0>
      pigment{ color Magenta*0.7 }  no_shadow }


translate R+<0.2, 4.9, -4>}
//------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------- end
