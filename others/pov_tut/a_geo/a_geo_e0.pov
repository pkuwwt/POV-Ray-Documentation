// POV-Ray 3.7 Scene File "a_geo_e0.pov"
...
#declare B  = < 4.0, 2.0, 2.0>;  
#declare C  = <-1.0, 1.0,-3.0>;
#declare AB = B-A;
#declare AC = C-A;
#declare D = A + AB + AC;
...
object{ Show_Yxz( A, Rl/2) pigment{ color Yellow*0.8}}
...
// object{ Vector( o,A, Rl) pigment{ color rgb<0.6,1,0>}  }
 ...
 cylinder{ B, D  Rl/2  pigment{ color Green*0.5 }}
 cylinder{ C, D  Rl/2  pigment{ color Green*0.5 }}



 triangle { A, B, C    pigment{ color rgb<0.6,1,0> transmit 0.5}}
 triangle { B, C, D    pigment{ color Green transmit 0.5 }}
...
text{ ttf "ARIAL.TTF"  concat( "AB=(",vstr(3, B-A,",",4, 1 ),")") , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate <0, 0.2,0>
        }
text{ ttf "ARIAL.TTF"  concat( "AC=(",vstr(3, C-A,",",4, 1 ),")") , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate <0,-0.2,0>
        }
text{ ttf "ARIAL.TTF"  concat( "D=(",vstr(3, D,"/",5, 1 ),")") , 0.1, 0       
...
text{ ttf "ARIAL.TTF"  concat( "A(ABDCA)=|N|= ",str( vlength(N), 5, 3 )) , 0.1, 0       
       scale 0.3 rotate<20,-44,0> translate < 0,-1.4,0>
     }
 
 pigment{ color Magenta*0.5 }  no_shadow 
translate C+<-1.2, 5, -1.5>}
//------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------- end
