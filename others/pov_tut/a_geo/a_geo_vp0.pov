// POV-Ray 3.7 Scene File "a_geo_vp0.pov"
...
sphere{ D, Rp              pigment{ color Orange } }
object{ Show_Yxz( D, Rl/2) pigment{ color Yellow }}

text { ttf "arial.ttf", "A",0.1,0
       scale 0.5 rotate<20,-45,0> translate A+<-0.2,0.0,-0.5> pigment{ color OrangeRed } no_shadow}


text { ttf "arial.ttf", "B",0.1,0
       scale 0.5 rotate<20,-45,0> translate B+<-0.2,0.3,-0.3> pigment{ color OrangeRed } no_shadow }

text { ttf "arial.ttf", "C",0.1,0
       scale 0.5 rotate<20,-45,0> translate C+< 0.2,0.6,-0.3> pigment{ color Orange } no_shadow }

text { ttf "arial.ttf", "D",0.1,0
       scale 0.5 rotate<20,-45,0> translate D+<-0.2,0.1,-0.6> pigment{ color Orange } no_shadow }
//------------------------------------------------------------------------------------



// object{ Vector( o,A, Rl) pigment{ color YellowGreen }  }

 object{ Vector( A,B, Rl) pigment{ color Green }}
 object{ Vector( A,C, Rl) pigment{ color Green }}
 cylinder{ B, D  Rl/2     pigment{ color Green }}
 cylinder{ C, D  Rl/2     pigment{ color Green }}

 object{ Vector( A,A+N, Rl)  pigment{ color Green*0.5 }}
 object{ Show_Yxz( A+N, Rl/2) pigment{ color Yellow }}

 text { ttf "arial.ttf", "N",0.1,0
       scale 0.5 rotate<20,-45,0> translate A+N+< 0.2,-0.5, 0.3> pigment{ color Green*0.5 } no_shadow }
...
text{ ttf "ARIAL.TTF"  concat( "ABxAC = N =(",vstr(3, N,",",5, 2 ),")") , 0.1, 0
       scale 0.3 rotate<20,-44,0> translate <0,-1.0,0>
      pigment{ color Magenta*0.7 }  no_shadow }

text{ ttf "ARIAL.TTF"  concat( "A(ACDB)=|N|= ",str( vlength(N), 5, 3 )) , 0.1, 0
       scale 0.3 rotate<20,-44,0> translate < 0,-1.4,0>
      pigment{ color Magenta*0.7 }  no_shadow }


translate B+<3.1, 0.6, -6.5>}
//------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------- end
