// POV-Ray 3.7 Scene File "a_geo_cir00.pov"
...
#declare M  = < 2.0, 2.5, 2.0>;  
#declare No  = < 1.0, 3.0, 0.5>;  
#declare Ro = 2.00;
//------------------------------------------------------------------------------------
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
sphere{ M, Rp              pigment{ color Red*0.9 }}
object{ Show_Yxz( M, Rl/2) pigment{ color Yellow  }}

text { ttf "arial.ttf", "M",0.1,0 
       scale 0.5 rotate<20,-45,0> translate o+<0.7,1.3, 0.2> pigment{ color rgb<0.6,1,0>} no_shadow}


text { ttf "arial.ttf", "r",0.1,0 
       scale 0.5 rotate<20,-45,0> translate M+<-0.6,0.7,-0.3> pigment{ color Red*0.9 } no_shadow }

text { ttf "arial.ttf", "N",0.1,0 
       scale 0.5 rotate<20,-45,0> translate M+No+<-0.7,-0.6,-0.3> pigment{ color Green*0.5 } no_shadow }

//------------------------------------------------------------------------------------

 object{ Vector( o,M, Rl)                         pigment{ color rgb<0.6,1,0>}  }
 object{ Vector( M,M+No, Rl)                      pigment{ color Green*0.5   }  }
 object{ Vector( M,M+VPerp_To_Plane(z,No)*Ro, Rl) pigment{ color Red*0.5     }  }
 

 object{ Circle_Line ( M, Ro, Rl, No) pigment{ color Orange }} 
 object{ Circle_Disc ( M, Ro, No)     pigment{ color Yellow transmit 0.5 }} 
