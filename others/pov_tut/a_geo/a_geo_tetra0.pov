...
//object{ Tetrahedron_by_Edges(P,V1,V2,V3, Rl/2, Rp, 0) pigment{ color Red*0.5 }}
/*
...
text { ttf "arial.ttf", "V3",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+V3/2+< 0.0,0.3, 0.0> pigment{ color Green } no_shadow }
*/
//------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------- end
