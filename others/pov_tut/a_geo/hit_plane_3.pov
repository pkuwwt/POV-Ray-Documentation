// PoVRay 3.7 Scene File "hit_plane_3.pov"
...
// plane by 3 Points:
#declare P  = <  3.0, 0.0, -2.0>;
#declare Q  = <  3.0, 4.0,  1.0>;
#declare R  = <  0.0, 0.0, -2.0>;
/*
...
text  { ttf "arial.ttf",
        ...
        translate A+<-1.0,0.4,-1.2> pigment{ color Green*0.5 } no_shadow}
...
// vector AB
object{ Vector( A,B, Rl) pigment{ color Green*0.8 }}
...
text  { ttf "arial.ttf",  "P",0.1,0
        scale 0.4 rotate<20,-45,0>
        translate P+<-0.0,0.1,-0.75> pigment{ color Green*0.5 } no_shadow }

// the point Q
sphere{ Q, Rp              pigment{ color Orange }}
object{ Show_Yxz( Q, Rl/2) pigment{ color Yellow }}
text  { ttf "arial.ttf",  "Q",0.1,0
        scale 0.4 rotate<20,-45,0>
        translate Q+<-0.0,0.3,-0.0> pigment{ color Green*0.5 } no_shadow }
...
text  { ttf "arial.ttf",  "R",0.1,0
        scale 0.4 rotate<20,-45,0>
        translate R+<-0.0,0.1,-0.75> pigment{ color Green*0.5 } no_shadow }

// vector P Q
object{ Vector( P,Q, Rl) pigment{ color OrangeRed }}
// vector P R
object{ Vector( P,R, Rl) pigment{ color OrangeRed }}


//---------------------------------------------------------------------- vectors ------
// object{ Plane_Dir( Start, Dir1, Dir2, Start, End ) pigment{ color Green}}
#declare Plane_1 =
object{ Plane_Dir(P, Q-P, R-P, <-3,0,-4>,<3,4,4> ) pigment{ color Yellow*1.2 transmit 0.5}}

/*
//object{ Plane_NoP( Normale, P, Start, End) pigment{ color Green}}
#declare Plane_1 =
object{ Plane_NoP(  N, P,  <-3,0,-4>,<2.5,4,4> ) pigment{ color Gray transmit 0.5}}
*/
object{ Plane_1}
...
// #declare Hit_the_Object =  trace ( Object, Start_Point, Direction, Hit_Normal );
#declare Hit_the_Object =  trace ( Plane_1, A, B-A, Hit_Normal );

// if trace ( Objcect, ...) does not find a point of intersection
...
// point of intersection:
 ...
 text{ ttf "ARIAL.TTF"
       ...
       translate Hit_the_Object+< 3,2.5,-4.0>
