// POV-Ray 3.7 Scene File "a_geo_calc01.pov"
// Author: Friedrich A. Lohmueller, 2006/2009/2011
...
#declare P  = < 5.0, 1.0,  0.5>;  
#declare Q  = < -1.0, 1.5, 3.5>;  
...
object{ Distance_Marker( P,Q, Rl) pigment{ color Green*0.7 } }


text { ttf "ARIAL.TTF", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 0.2,0.3,0> pigment{ color Red*0.5 } no_shadow}

text { ttf "ARIAL.TTF", "Q",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+<-0.2,0.2,0> pigment{ color Red*0.5 } no_shadow }
...
sphere{ M_PQ,Rp pigment{ color Magenta*0.5 } }
object{ Show_Yxz( M_PQ, Rl/2) pigment{ color Cyan } }
 
//------------------------------------------------------------------------------------
// calculate :

text{ ttf "ARIAL.TTF"  concat( "|PQ| = ",str(vlength( Q-P),3,4) ) , 0.1, 0       
       scale 0.35 rotate<20,-40,0> translate M_PQ+< 0.4,0.0,0>
      pigment{ color Red*0.5 }  no_shadow }

text{ ttf "ARIAL.TTF"  concat( "M(PQ) = (", vstr(3, (P+Q)/2 ,"/ ",0,1),")" ) , 0.1, 0       
      scale 0.35   rotate<20,-40,0> translate M_PQ+< 0.2,0.4,0>
