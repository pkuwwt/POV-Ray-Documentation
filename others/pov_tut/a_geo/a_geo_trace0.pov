// POV-Ray 3.7 Scene File "a_geo_trace0.pov"
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{<1,3500,-1> color White*0.8}
light_source{<40.0 ,40.5 ,-40.0> color White*0.5}
// sky -------------------------------------------------------------------
sky_sphere{ pigment{ gradient <0,1,0>
                     color_map{ [0   color rgb<1,1,1>         ]//White
                                [0.4 color rgb<0.14,0.24,0.56>]//
                                [0.6 color rgb<0.14,0.24,0.56>]//<0.14,0.14,0.56>]//~Navy
...
object{ AxisXYZ( 5.5, 5.5, 6.5, Texture_A_Dark, Texture_A_Light)} // <<<<<<<<<<<<<<<<< adapt the axes here !!!
...
#declare Txz  = <-3.0, 0.0, -3.0>;
#declare Tyz  = < 0.0, 1.5, -1.5>;
...
#declare Size = 4.00;
box { <-Size,0,-Size>,<Size,0.001,Size>    //xy plane with layered textures
        texture { pigment{color rgbt<1.0,1.0,1.0,0.55>*1.1}
                  finish {ambient 0.45 diffuse 0.85}}
...
box { <-Size,0,-Size>,<Size,0.001,Size>    //xy plane with layered textures
        texture { pigment{color rgbt<1,0.75,0,0.55>*1.1}
                  finish {ambient 0.45 diffuse 0.85}}
...
box { <-Size,0,-Size>,<Size,0.001,Size>    //xy plane with layered textures
        texture { pigment{color rgbt<0.5,1,0,0.55>*1.1}
                  finish {ambient 0.45 diffuse 0.85}}
...
object{ Show_Yxy( Txy, Rl) pigment{ color Red }}

sphere{ Txz, Rp            pigment{ color Red*.5 } }
object{ Show_Yxz( Txz, Rl) pigment{ color Red*0.5 }}

sphere{ Tyz, Rp            pigment{ color rgb<0.5,0,1>*0.5} }
object{ Show_Yyz( Tyz, Rl) pigment{ color rgb<0.5,0,1>*0.5 }}

#declare Rotate = <10,-25,0>;

text { ttf "arial.ttf", "A",0.1,0
       scale 0.5 rotate Rotate translate A+<-0.2,0.2,-0.2> pigment{ color Green } no_shadow}
...
text { ttf "arial.ttf", "Txy",0.1,0
       scale 0.5 rotate Rotate translate Txy+<-0.2,1.0,-0.7> pigment{ color Red } no_shadow }

text { ttf "arial.ttf", "Tyz",0.1,0
       scale 0.5 rotate Rotate translate Tyz+< 0.5, 0.2,-0.7> pigment{ color rgb<0.5,0,1> } no_shadow }

text { ttf "arial.ttf", "Txz",0.1,0
       scale 0.5 rotate Rotate translate Txz+<-0.5,0.6,-0.7> pigment{ color Red*0.5 } no_shadow }
...
//------------------------------------------------------------------------------------
 ...
 cylinder{ A-10*AB, B+10*AB,  Rl/2  pigment{ color Green*0.5 }}
//------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------- end
