// POV-Ray 3.7 Scene File "a_geo_tetra6.pov"
...
#declare V1  = <-2.0, 2.5, 5.0>;  
#declare V2  = <-7.0, 1.0,-1.0>;
#declare V3  = <-3.0, 6.0, 2.0>;
...
//object{ Tetrahedron_by_Edges(P,V1,V2,V3, 0, 0, 1)     pigment{ color rgb<0.5,0,1> transmit 0.5 }}
object{ Tetrahedron_by_Edges(P,V1,V2,V3, Rl/2, Rp, 0) pigment{ color Red*0.8 }}

object{ Vector( o,   P, Rl) pigment{ color rgb<0.6,1,0> }  }
object{ Vector( o,P+V1, Rl) pigment{ color rgb<0.6,1,0> }  }
object{ Vector( o,P+V2, Rl) pigment{ color rgb<0.6,1,0> }  }
object{ Vector( o,P+V3, Rl) pigment{ color rgb<0.6,1,0> }  }
