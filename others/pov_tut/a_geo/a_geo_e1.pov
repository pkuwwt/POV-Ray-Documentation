// POV-Ray 3.7 Scene File "a_geo_e1.pov"
...
object{ AxisXYZ( 6.0, 3.5, 7.0, Texture_A_Dark, Texture_A_Light) no_shadow} // <<<<<<<<<<<<<<<<< adapt the axes here !!!
...
#declare P  = < 2.0, 0.0, 0.0>;  
#declare M1 = < 2.0, 0.0, 1.0>;  
#declare M2 = < 0.0, 2.0, 1.0>;

#declare Q  = < 1.0, 0.0,-3.0>;  
#declare M3 = < 1.0, 0.0,-2.0>;  
#declare M4 = <-3.0, 2.0, 2.0>;
//------------------------------------------------------------------------------------
// --------------------------------------------------------------- Zeichnen ---------- 
// ---------------------------------------------------------------- Drawing ---------- 
sphere{ P, Rp  pigment{ color Green*0.5 } }
object{ Show_Yxz( P, Rl/2) pigment{ color Yellow }}
object{ Show_Yxz( P+M2, Rl/2) pigment{ color Yellow }}

text { ttf "arial.ttf", "P",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 0.4,0.2,0.1> pigment{ color Green*0.5 } no_shadow}
text { ttf "arial.ttf", "Mp2",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 0.6,2.2,0.4> pigment{ color Green*0.5 } no_shadow}
text { ttf "arial.ttf", "Mp1",0.1,0 
       scale 0.5 rotate<20,-45,0> translate P+< 2.0,0.4,0.4> pigment{ color Green*0.5 } no_shadow}

sphere{ Q, Rp                 pigment{ color Red*0.5}}
object{ Show_Yxz( Q, Rl/2)    pigment{ color Yellow }}
object{ Show_Yxz( Q+M4, Rl/2) pigment{ color Yellow }} 

text { ttf "arial.ttf", "Q",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+< 0.9, 0.2,-0.6> pigment{ color BlueViolet } no_shadow}
text { ttf "arial.ttf", "Mq2",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+<-0.5,3.1,0.0>   pigment{ color BlueViolet } no_shadow}
text { ttf "arial.ttf", "Mq1",0.1,0 
       scale 0.5 rotate<20,-45,0> translate Q+< 1.5, 0.1,-2.0> pigment{ color BlueViolet } no_shadow}
//------------------------------------------------------------------------------------

 object{ Vector( o,P, Rl)    pigment{ color Green*0.5 } no_shadow }
 object{ Vector( P,P+M1, Rl) pigment{ color rgb<0.6,1,0> } no_shadow }
 object{ Vector( P,P+M2, Rl) pigment{ color rgb<0.6,1,0> } no_shadow }


 object{ Vector( P-10*M1,P+10*M1, Rl/2) pigment{ color Green*0.5 } no_shadow }


 object{ Plane_Dir( P, M1, M2, <-4,-1,-5>, <4,2,5>) pigment{ color rgb<0.6,1,0> transmit 0.5 }}

 object{ Vector( o,Q, Rl) pigment{ color Red*0.5 }  }
 object{ Vector( Q,Q+M3, Rl) pigment{ color BlueViolet } no_shadow }
 object{ Vector( Q,Q+M4, Rl) pigment{ color BlueViolet } no_shadow }


 object{ Vector( Q-10*M3,Q+10*M3, Rl/2) pigment{ color BlueViolet } no_shadow}


 object{ Plane_Dir( Q, M3, M4, <-6,-1,-5>, <4,2,4>) pigment{ color BlueViolet transmit 0.5} no_shadow}
