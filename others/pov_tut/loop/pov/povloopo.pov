// POV-Ray 3.7 Scene File "povloopo.pov"
...
#case (1)
  ...
  #declare Camera_Look_At  =  < 0.55 , 0.1 ,  0.0>;
  #declare Camera_Angle    =  45 ;
#break
#case (2)
...
sphere{<0,0,0>,1 hollow
       texture{pigment{gradient <0,1,0>
                       color_map{[0.00 color rgb<0.65,0.5,1>]
                                 [0.15 color rgb<0.65,0.5,1>]
                                 [0.50 color rgb<1,1,1>]
                                 [0.85 color rgb<0.65,0.5,1>]
                                 [1.00 color rgb<0.65,0.5,1>]}
...
union{
 ...
 text   { ttf "arial.ttf",  "x",  0.15,  0  texture{Tex_Dark} 
          rotate< 0,-25,0> scale 0.65 translate <AxisLenX+0.00,0.3, 0.10> no_shadow}
#end // of #if 
#if (AxisLenY != 0)
 object { Axis_(AxisLenY, Tex_Dark, Tex_Light)   rotate< 0,0,  0>}// y-Axis
 text   { ttf "arial.ttf",  "y",  0.15,  0  texture{Tex_Dark}    
          rotate<10,0,0> scale 0.65 translate <-0.55,AxisLenY+0.20,-0.10>  rotate<0,-15,0> no_shadow}
#end // of #if 
#if (AxisLenZ != 0)
 object { Axis_(AxisLenZ, Tex_Dark, Tex_Light)   rotate<90,0,  0>}// z-Axis
 text   { ttf "arial.ttf",  "z",  0.15,  0  texture{Tex_Dark}
          rotate< 0,-15,0> scale 0.8 translate <-0.75,0.2,AxisLenZ+0.10> no_shadow}
#end // of #if 
} // end of union                      
...
object{ AxisXYZ( 4.2, 2.5, 6.5, Texture_A_Dark, Texture_A_Light) scale 1 }
...
union{
 ...
 cylinder{<0,-Profile_H,0>,<0, Profile_H,0>,Profile_R  translate<0.01,0,0>
          texture{ pigment{ color rgb<1,0.75,0.0>}
                   finish { phong 1}
                 }
         }
 sphere  {<0,0,0>,Profile_R  translate<0,-Profile_H,0>}
 texture{ pigment{ color rgb<0.85,0.05,0.25>}
          finish { phong 1}}}
