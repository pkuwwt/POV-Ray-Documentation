// POV-Ray 3.7 Scene File "povloop9d.pov"
...
#case (0)
  #declare Camera_Location = < 0.00, 1.00,-15.00> ;  // front view
  #declare Camera_Look_At  = < 0.00, 1.00 , 0.0> ;
  #declare Camera_Angle    =  45 ;
#break
#case (1)
  #declare Camera_Location =  < 5.00, 6.00,-8.00> ;  // diagonal view
  #declare Camera_Look_At  =  < 0.5, -1.05 ,  0.0>;
  #declare Camera_Angle    =  67 ;
#break
#case (2)
...
sphere{<0,0,0>,1 hollow
       texture{pigment{gradient <0,1,0>
                       color_map{[0.00 color rgb<1,0.65,0>*0.1]
                                 [0.15 color rgb<1,0.65,0>]
                                 [0.50 color rgb<1,1,1>]
                                 [0.85 color rgb<1,0.65,0>*0.1]
...
#declare Ball = 
 ...
 texture{ Polished_Chrome
          pigment { color rgb<0.60,0.20,0.75>}
          finish  { phong 1}}}
//---------------------------------------------------------
