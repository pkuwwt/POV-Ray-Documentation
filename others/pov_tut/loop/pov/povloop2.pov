...
#case (0)
  #declare Camera_Location = < 3.00, 2.00,-30.00> ;  // front view
  #declare Camera_Look_At  = < 3.00, 2.00,  0.00> ;
  #declare Camera_Angle    =  15 ;
#break
#case (1)
  #declare Camera_Location =  <6.0 ,7.0 ,-4.0> ;  // diagonal view
  #declare Camera_Look_At  =  < 3.25 , 0.5 , 1.5> ;
  #declare Camera_Angle    =  56 ;
#break
#case (2)
  #declare Camera_Location = <12.0, 2.0 , 0.0> ;  // right side view
...
//------------------------------------------------------------------------
// sun -------------------------------------------------------------------
light_source{<-1500,2000, 1500> color rgb<1,1,1>*0.7}                // sun 
...
union{
 ...
 text   { ttf "arial.ttf",  "x",  0.15,  0  texture{Tex_Dark} 
          rotate<30,-15,0> scale 0.65 translate <AxisLenX+0.05,0.4,-0.10> no_shadow}
#end // of #if 
#if (AxisLenY != 0)
 object { Axis_(AxisLenY, Tex_Dark, Tex_Light)   rotate< 0,0,  0>}// y-Axis
 text   { ttf "arial.ttf",  "y",  0.15,  0  texture{Tex_Dark}    
          rotate<30,0,0> scale 0.65 translate <-0.65,AxisLenY+0.30,-0.10>  rotate<0,-15,0> no_shadow}
#end // of #if 
#if (AxisLenZ != 0)
 object { Axis_(AxisLenZ, Tex_Dark, Tex_Light)   rotate<90,0,  0>}// z-Axis
 text   { ttf "arial.ttf",  "z",  0.15,  0  texture{Tex_Dark}
          rotate<30,-15,0> scale 0.95 translate <-0.75,0.2,AxisLenZ+0.10> no_shadow}
#end // of #if 
} // end of union
...
object{ AxisXYZ( 7.00, 1.00, 7.30, Texture_A_Dark, Texture_A_Light) scale 1 }
