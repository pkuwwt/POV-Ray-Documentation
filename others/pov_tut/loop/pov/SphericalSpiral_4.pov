// POV-Ray 3.7 Scene File "SphericalSpiral_4.pov"
...
#break
#case (1)
  #declare Camera_Location =  <4.0  , 4.5 ,-4.0> ;  // diagonal view
...
//object{ AxisXYZ( 3.00, 2.00, 5.00, Texture_A_Dark, Texture_A_Light) scale 0.4 }
...
#declare Element = 
 sphere{ <0,0,0>,0.05  
         texture{ pigment{ color rgb<0.5,0,0>} // 0.8,0.4,0> }
...
union{ //------------------------------------------------------
 ...
 #while (NrB< EndB) 
   ...
   #while (Nr< End) 
    object{ Element  scale 1+<0,0,4>*cos(radians(-90+NrB *180/EndB)) 
...
sphere { <0,0,0>, 1 
        ...
        texture { pigment{ color rgbt<1.00,1, 1.00,0.5>}
