// POV-Ray 3.7 Scene File "povloopm.pov"
...
sphere{<0,0,0>,1 hollow
       texture{pigment{gradient <0,1,0>
                       color_map{[0.0 color rgb<1,0.67,0>]
                                 [0.3 color rgb<1,0.67,0>]
                                 [0.5 color rgb<1,1,1>]
                                 [0.7 color rgb<1,0.67,0>]
...
object{ AxisXYZ( 4.9, 2.5, 6.5, Texture_A_Dark, Texture_A_Light) scale 1 }
...
//----------------------------------------------------------------------
//----------------------------------------------------------------------
#declare Profile_R = 0.1;
#declare Profile_H = 0.75;
...
union{
 ...
 sphere  {<0,0,0>,Profile_R  translate<0,-Profile_H,0>}
 texture{ pigment{ color rgb<0.65,0.35,0.85>}
          finish { phong 1}}}
//---------------------------------------------------------
