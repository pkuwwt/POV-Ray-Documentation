// POV-Ray 3.7 Scene File "povloop6.pov"
...
#case (1)
  ...
  #declare Camera_Look_At  =  < 0.65,-0.30, 0.00>;
  #declare Camera_Angle    =  58 ;
#break
#case (2)
  #declare Camera_Location = <12.00, 1.00,  0.00> ;  // right side view
...
sphere{<0,0,0>,1 hollow
       texture{pigment{gradient <0,1,0>
                       color_map{[0.0 color rgb<1,1,1>*0.05]
                                 [0.3 color rgb<1,1,1>*0.05]
                                 [0.5 color rgb<1,1,1>*0.5]
                                 [0.7 color rgb<1,1,1>*0.05]
                                 [1.0 color rgb<1,1,1>*0.05]}
...
object{ AxisXYZ( 5.2, 3.0, 6.5, Texture_A_Dark, Texture_A_Light) scale 1 }
...
#declare Ball =
 sphere{<0,0,0>,0.075
         texture {  Polished_Chrome
                    pigment{ color rgb< 0.95, 0.35, 0.10>*0.99 }
                    normal { bumps 0.5 scale 0.005}
                    finish { phong 1 specular 0.15 }
                 } // end of texture
        }
//------------------------------------
