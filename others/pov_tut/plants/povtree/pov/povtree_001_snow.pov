// POV-Ray 3.6 / 3.7 Scene File "povtree_001_snow.pov"
...
#include "TOMTREE/TOMTREE-1.5.inc"
//-------------------------------------------------------------
#declare Tree_01s = object{ TREE double_illuminate hollow}
union{ 
object{ Tree_01 }  
object{ Tree_01s scale<1.25,1,1.0>translate<0.015,0,-0.005> }  
        scale  4
        rotate<0, 0,0>
        translate<0,0.00,0>
      } //------------------------------------------------------
