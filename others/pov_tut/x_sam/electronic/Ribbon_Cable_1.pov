...
#case (1)
  #declare Ultra_Wide_Angle_On = 0;// don't use fish eye - for proper text
  #declare Camera_Position = <13.00, 20.00,-17.00> ;  // front view
  #declare Camera_Look_At  = < 7.50, 1.00,  6.00> ;
...
object{ AxisXYZ(  8, 5, 10, Texture_A_Dark, Texture_A_Light) scale 2}
...
// markers 
// start
sphere {  <0,0,0>,0.6 scale<1,0.2,1> pigment{ rgb<0.5,1,0>}} 
// end 
cylinder{ <0,0,0>,<0,5,0>,0.25       pigment{ rgb<0.5,1,0>}
          translate <15, 0,20> }  
