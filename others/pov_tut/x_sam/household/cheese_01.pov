// POV-Ray 3.6 / 3.7 Scene File "Cheese_03.pov"
...
object{ AxisXYZ( 6.6, 3.25, 1.25, Texture_A_Dark, Texture_A_Light) scale 0.07 }
...
#declare Cheese_Texture =  
         texture { pigment{ color rgb< 1.0, 0.85, 0.35> } //  deep yellow 
                   normal { bumps 0.1 scale 0.015 }
                   finish { phong 1 reflection 0.03}
                 } // end of texture 
  ...
  #while (NrY <  Max_Num_Y)                               
    sphere{ <0,0,0>,Max_D/2
       scale< 1+0.5*(rand(Rnd_)),
              1-0.25*(rand(Rnd_)),
              1+0.5*(0.5-rand(Rnd_))>
       translate<(NrX+0.5)+0.65*(0.5-rand(Rnd_)), (NrY+0.5)+1*(0.5-rand(Rnd_)),0.25*(0.5-rand(Rnd_))>*Max_D
    ...
    sphere{ <0,0,0>,Max_D/2
       scale< 1+0.5*(rand(Rnd_)),
              1-0.25*(rand(Rnd_)),
              1+0.5*(0.5-rand(Rnd_))>
       translate<(NrX+0.25)+0.85*(0.5-rand(Rnd_)), (NrY+0.25)+1.25*(0.5-rand(Rnd_)),0.25*(0.5-rand(Rnd_))>*Max_D
       rotate<0,0,0>
    } // ------- end sphere
